function getButtonStyling(styleType) {
    const primaryButtonStyling = "border border-[#7c7c00;] bg-gradient-to-r from-blue-400  hover:from-blue-600 text-[#000] px-8";
    const secondaryButtonStyling = "bg-gray-500 border border-gray-700 hover:bg-gray-700 hover:border-gray-900";
    const warningButtonStyling = "border border-[#7c7c00;] bg-gradient-to-r from-yellow-400  hover:from-yellow-500 text-[#000] px-8";
